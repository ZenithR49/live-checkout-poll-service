...
> Design notes for **live-checkout-poll-service** — a runnable typescript example that Typed Node service for live fulfillment polls and realtime order updates.
...
- **Feature code** — the actual task: live checkout polling.
